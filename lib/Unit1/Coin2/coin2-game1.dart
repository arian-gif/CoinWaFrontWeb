...
void main() {
  runApp(const FallingCoins());
}

class FallingCoins extends StatelessWidget {
  const FallingCoins({super.key});
...
class _CatchingGameScreenState extends State<CatchingGameScreen> {
  ...
  void _spawnObject() {
    setState(() {
      bool isNeed = _random.nextBool(); // true = coin, false = hammer
      String type = isNeed ? 'coin' : 'hammer';
  ...
  String _getImagePath(FallingObject object) {
    if (object.isNeed) {
      return 'assets/flatcoin.png'; // coin
    } else {
      return 'assets/hammer.png'; // hammer
    }
  }
}
                        ...
                        ElevatedButton(
                          ...
                          style: ElevatedButton.styleFrom(
                            ...
                            backgroundColor: const Color.fromARGB(
                                255, 120, 112, 222), // Text color
                            textStyle: const TextStyle(
                              fontSize: 20,
                              fontFamily:
                                  'Source', // Use the custom font here if needed
                            ),
                          ),
