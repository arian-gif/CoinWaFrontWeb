...
class _SmartLearnState extends State<SmartLearn> {
  List<SmartItemData> smartItems = [
    SmartItemData('SPECIFIC', 'Clear and Precise'),
    SmartItemData('MEASURABLE', 'Trackable Progress'),
    SmartItemData('ACHIEVABLE', 'Realistic/Attainable'),
    SmartItemData('RELEVANT', 'Important to You'),
    SmartItemData('TIMED', 'Reasonable Deadline'),
  ];
                ...
                const Row(
                      ...
                      child: Container(
                        ...
                        child: const Center(
                          child: Padding(
                            ...
                            child: Text(
                              "SMART is a helpful acronym for setting saving goals! Let's dive deeper",
                  ...
                  Provider.of<ProgressProvider>(context, listen: false).setSublevel(context, 4);
                              ...
                              Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) => const Coin3Scene1(),
                                ),
                              );
                            },
