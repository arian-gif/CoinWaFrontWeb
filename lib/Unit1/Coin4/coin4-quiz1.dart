...
class Coin4Quiz1 extends StatefulWidget {
  final bool isRepeat;
  const Coin4Quiz1({super.key, required this.isRepeat});

  @override
  State<Coin4Quiz1> createState() => _Coin4Quiz1State();
}

class _Coin4Quiz1State extends State<Coin4Quiz1> {
                    ...
                    child: Column(
                      children: [
                        Row(
                          ...
                          children: [
                            SpeechBubble(
                                "Now, where do you put your savings?", true)
                          ],
                        ),
                        Row(
                        ...
                        Expanded(
                          child: ListView(
                            children: [
                              ...
                              option("A: Piggy Bank", false),
                              option("B: Online Bank Account", false),
                              option("C: Phone Banking / Saving App", false),
                              option("D: With your Parents", false),
                              option("E: The Police", false),
                              option("F: All of the Above", false),
                              option("G: A, B, C, and D", true),
                            ],
                          ),
                        ),
                        Padding(
                                  ...
                                  onTap: () {
                                    ...
                                    if (widget.isRepeat) {
                                      navigateToNextQuestion(
                                          context, 4, "Where to Save Your Money");
                                    } else {
                                      Navigator.push(
                                        context,
                                        MaterialPageRoute(
                                          builder: (context) =>
                                              const Coin4Quiz2(isRepeat: false),
                                        ),
                                      );
                                    }
                                  },
