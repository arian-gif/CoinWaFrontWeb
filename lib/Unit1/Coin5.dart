...
class Coin5 extends StatelessWidget {
  @override
...
class _AnimationScreenState extends State<AnimationScreen> with SingleTickerProviderStateMixin {
  ...
  void _navigateToNextScreen() {
    if (_isConfettiDone) {
      ...
      if (!profileProvider.badges.contains("assets/Badges/piggybank.png")) {
                                  profileProvider.updateUserBadge(context, "piggybank");
                                }
              ...
              child: FadeTransition(
                ...
                child: const Padding(
                  ...
                  child: Text(
                    ...
                    'Congratulations! You filled Piggy Bank 1: Saving!',
                    style: TextStyle(
