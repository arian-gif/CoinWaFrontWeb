...
class Coin12interest2 extends StatefulWidget {
  const Coin12interest2({super.key});

  @override
  State<Coin12interest2> createState() => _InterestState();
}

class _InterestState extends State<Coin12interest2> {
  double boxWidth1 = 50;
  double boxWidth2 = 50;
  double boxWidth3 = 50;
                        ...
                        if (showImage1 && showImage2 && showImage3) 
                          Padding(
                            ...
                            child: TextButton(onPressed: (){Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) => const Coin12interest3(),
                                ),
