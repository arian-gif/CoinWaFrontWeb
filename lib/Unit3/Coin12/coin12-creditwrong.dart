...
class Coin12creditwrong extends StatelessWidget {
  const Coin12creditwrong({super.key});
                ...
                SingleChildScrollView(
                  child: Column(
                    children: [
                      ...
                      const Text(
                        'Good guess, but the scores typically range from 300 to 900, with scores after 700 being considered good!',
