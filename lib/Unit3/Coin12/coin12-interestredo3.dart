...
class Coin12interest3 extends StatefulWidget {
  const Coin12interest3({super.key});

  @override
  State<Coin12interest3> createState() => _InterestState();
}

class _InterestState extends State<Coin12interest3> {
  double boxWidth1 = 50;
  double boxWidth2 = 50;
  double boxWidth3 = 50;
      ...
      body: GestureDetector(
        onTap: () {
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => const Coin12interest4(),
            ),
          );
        },
        child: SafeArea(
            ...
            children: [
              ...
              Align(
                ...
                child: Padding(
                  ...
                  child: WawaTalking(
                    'However, interest for a credit card refers to how the amount of money you BORROWED grows over time',
                    "assets/wawaTalk.png"),
                ),
              ),
              ExitButton(),
