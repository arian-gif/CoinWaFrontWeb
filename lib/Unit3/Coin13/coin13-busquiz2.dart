...
class Coin13busquiz2 extends StatelessWidget {
  final bool isRepeat;
  const Coin13busquiz2({super.key, required this.isRepeat});
  ...
  Widget build(BuildContext context) {
    return Coin13QuizTemplate(
      ...
      question: "Now, knowing what a Business credit card is, who do you think would likely use the card?", 
      correctOption: 1, 
      isRepeat: isRepeat, 
