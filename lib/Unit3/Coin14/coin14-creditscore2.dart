...
class Coin14CreditScore2 extends StatelessWidget {
  const Coin14CreditScore2({super.key});
    ...
    return SafeArea(
      child: GestureDetector(
        onTap: () {
         ...
         Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => const Coin14Quiz1(isRepeat: false)),
                );
        },
        child: Scaffold(
                  ...
                  child: Column(
                    children: [
                      ...
                      const Padding(
                        ...
                        child: Text(
                          'Well, using a credit card allows you to build a history of on-time payments which can increase your credit score ',
