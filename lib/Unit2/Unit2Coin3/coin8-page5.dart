...
class Coin8Page5 extends StatelessWidget {
  const Coin8Page5({super.key});
            ...
            GestureDetector(
              onTap: () {
                 if (Provider.of<ProgressProvider>(context, listen: false).level == 8) {
                  ...
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => const Coin8Page6()),
                  );
              },
              child: Center(child: WawaTalking('Eventually, you need to pay who you owe back in order to get rid of the liability!', "assets/wawaTalk.png"))),
            ExitButton(),
            const Row(
              children: [
                Expanded(
