...
class Coin9Page3Part1 extends StatelessWidget {
  const Coin9Page3Part1({super.key});
              ...
              child: GestureDetector(
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Coin9Page3Part2()),
                  );
                },
                child: Center(
                  child: Column(
                    ...
                    children: [
                      ...
                      purpleTextBubbleYellow(
                          "In reality, a person's net worth is their value after subtracting their liabilities from their assets!",
                          ["net", "worth"]),
